...
export default function Header() {
  ...
  const linkStlyes = 'text-white font-[Lexend] font-dlig-on text-[14px] not-italic font-medium leading-[21px] flex items-center self-stretch'
  ...
  return (
    ...
    <header className='flex py-3 px-10 justify-between items-center self-stretch border-b border-solid border-borderColor bg-background h-[65px]'>
      <div className='flex items-center gap-4'>
        <img src='./src/assets/vector-0.svg' alt='logo' className='w-4 flex-1 items-center' />
      ...
      <div className='flex justify-end items-start gap-8 flex-1'>
        <div className='flex h-10 items-center gap-9'>
          ...
          <button className='flex h-10 min-w-[84px] max-w-[480px] px-4 justify-center items-center rounded-xl bg-button'>
